...
WeaveCrypto.prototype = {
    ...
    initNSS : function() {
        ...
        var nsslib;
//@line 140 "/home/wojtek/Repositories/firefox-45.0.2/services/crypto/modules/WeaveCrypto.js"
        let file = Services.dirsvc.get("GreBinD", Ci.nsILocalFile);
        file.append(path);
        this.log("Trying NSS library with path " + file.path);
        nsslib = ctypes.open(file.path);
//@line 145 "/home/wojtek/Repositories/firefox-45.0.2/services/crypto/modules/WeaveCrypto.js"
